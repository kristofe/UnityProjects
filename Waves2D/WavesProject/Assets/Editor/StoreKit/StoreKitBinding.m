...
void _requestProductData( const char *productIdentifiers )
{
	...
	NSString *identifiers = [NSString stringWithUTF8String:productIdentifiers];
...
{
	NSString *productId = [NSString stringWithUTF8String:product];
...
{
	NSString *receipt = [NSString stringWithUTF8String:base64EncodedTransactionReceipt];
