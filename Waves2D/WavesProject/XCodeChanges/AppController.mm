...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	[FlurryAPI startSession:@"FHF18SVNFNU3RBZW6IPH"];
	
	[Mobclix start]; // Start the Mobclix library 
	NSLog(@"Show Ad: 1"); 
	[NSTimer scheduledTimerWithTimeInterval: 5.0 target: self selector: @selector(showAdViewMobclix) userInfo: nil repeats: NO]; 
	NSLog(@"Show Ad: 2");
}
...
- (void) showAdViewMobclix { 
	printf_console("showAdViewMobclix: about to make Ad View!"); 
    
	//Landscape 
	//adView = [[UIWindow alloc] initWithFrame: CGRectMake(-125, 215, 300, 50)]; 
	//CGAffineTransform transform = adView.transform; 
	//adView.transform = CGAffineTransformRotate(transform, 1.57); 
	//adView.hidden = NO; 
	
	//Portrait
	adView = [[UIWindow alloc] initWithFrame: CGRectMake(10, 430, 300, 50)];
	//adView = [[UIWindow alloc] initWithFrame: CGRectMake(-125, 215, 300, 50)]; 
	//CGAffineTransform transform = adView.transform; 
	//adView.transform = CGAffineTransformRotate(transform, 1.57); 
	adView.hidden = NO; 
	...
	bannerAd.delegate = self; //Optional 
	[adView addSubview: bannerAd]; 
    
	bannerAd.refreshTime = 10.0; 
    
	[bannerAd release]; 
    
	NSLog(@"showAdViewMobclix: Ad View done!"); 
} 

- (BOOL) adViewShouldTouchThrough: (MobclixAdView *) adView{ 
	NSLog(@"User touched banner ad."); 
	UIWindow* view = [self getAdView]; 
	view.frame = CGRectMake(0, 0, 480, 320); 
	
	//Uncomment for landscape
	//CGAffineTransform transform = view.transform; 
	//view.transform = CGAffineTransformRotate(transform, -1.57); 
	//view.frame = CGRectMake(-125, 215, 300, 50); 
	return YES; 
} 

- (void) adViewDidFinishTouchThrough: (MobclixAdView *) adView{ 
	NSLog(@"User returned from banner ad."); 
	UIWindow* view = [self getAdView]; 
	view.frame = CGRectMake(10, 430, 300, 50); 
	//Uncomment for landscape
	//view.frame = CGRectMake(-125, 215, 300, 50);
	//CGAffineTransform transform = view.transform; 
	//view.transform = CGAffineTransformRotate(transform, 1.57); 
